...
?>
    ...
    <div class="container">
     ...
     <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Gerenciar dados das Palestras</h1>
        </div>
    </section>
                                ...
                                <div class="modal fade" id="delMini<?= $minicursos[$key]['id_Mcurso']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                      	<form action="GerenciadorPalestras.php" method="post">
                                      		<div class="row">
                                      			<div class="col-md">
...
<?php
            ...
            if(isset($_POST['deletarMinicurso'])){
                ...
                $codigo = "DELETE FROM palestras WHERE id_Mcurso = '$id_Mcurso'";
                ...
                <script type="text/javascript" >
                    ...
                    location.href="GerenciadorPalestras.php";
                </script>
...
<div class="modal fade" data-backdrop="static" id="mini<?= $minicursos[$key]['id_Mcurso']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <form action="GerenciadorPalestras.php" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form action="GerenciadorPalestras.php" method="post" enctype="multipart/form-data" >
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                <button type="submit" name="inserirMinicurso" class="btn btn-primary">Inserir palestra</button>
            </div>
        </form>
        <?php
        ...
        if(isset($_POST['inserirMinicurso'])){  
            ...
            $codigoInsert = "INSERT INTO palestras (nome_Mcurso, des_Mcurso, local_Mcurso, dia_Mcurso, diaTermina_Mcurso, ministrante_Mcurso, ch_Mcurso, vagas_Mcurso, img_Minicurso, FK_Curso_id_curso) VALUES ('$nome_Mcurso', '$des_Mcurso', '$local_Mcurso', '$dia_Mcurso', '$dia_Terminio', '$ministrante_Mcurso', '$carga_Mcurso', '$vagas_Mcurso', '$endereco_imagem', $FK_Curso_id_curso)";
